...
<div id="footer">
			...
			<div class="footer-column">
				<h4>About Us</h4>
				<ul>
					<li><a href="/about">dig.ccMixter</a></li>
					<li><a href="http://ccmixter.org/about">ccMixter</a></li>
					<li><a href="http://tunetrack.net">TuneTrack</a></li>
					<li><a href="http://tunetrack.net/artistech/pages/philosophy/">ArtIsTech Media</a></li>
				</ul>
			</div>
			<div class="footer-column">
				<h4>News</h4>
			...
			<div class="footer-column">
				<h4>Information</h4>
				<ul>
					<li><a href="/about#credits">Site Credits</a></li>
					<li><a href="http://ccmixter.org/privacy">Privacy Policy</a></li>
					<li><a href="http://ccmixter.org/terms">Terms of Use</a></li>
				</ul>
			</div>
			<div class="footer-column">
				<h4>Need help?</h4>
